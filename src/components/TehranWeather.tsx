...
import { fetchWeatherByLocation } from '../../redux/slices/tehranWeatherSlice';
...
const TehranWeather = () => {
  ...
  const { forecast, currentWeather, status } = useAppSelector((state) => state.weather);
      ...
      <div className="mb-6 mt-6 ml-2 mr-2 p-4 bg-[#1e293b] rounded-lg flex justify-between items-center text-white">
        <div>
          <h2 className="text-2xl font-bold">
            Current Weather in {currentWeather?.locationName || 'your location'}
          </h2>
